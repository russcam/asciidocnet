# scenarios from asciidoctor: https://github.com/asciidoctor/asciidoctor
Feature: Text Formatting
  ...
  @ignore
  # TODO: Need to process inline elements of inline elements (i.e. nest elements) for this to pass
