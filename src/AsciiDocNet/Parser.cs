...
namespace AsciiDocNet
{
    ...
    public class Parser : IParser
    {
        ...
        private void Parse(Container container, IDocumentReader reader, Regex delimiterRegex, ref List<string> buffer, ref AttributeList attributes)
        {
            while (reader.Line != null)
            {
                ...
                {
                    ProcessUnorderedListItem(new ParserContext(container, delimiterRegex), reader, ref buffer, ref attributes);
                    continue;
                }
                else if (PatternMatcher.CheckListItem.IsMatch(reader.Line))
                {
                    ProcessCheckListItem(new ParserContext(container, delimiterRegex), reader, ref buffer, ref attributes);
                    continue;
                }
                else if (PatternMatcher.OrderedListItem.IsMatch(reader.Line))
                {
                    ProcessOrderedListItem(new ParserContext(container, delimiterRegex), reader, ref buffer, ref attributes);
                    continue;
                }
                else if (PatternMatcher.LabeledListItem.IsMatch(reader.Line))
                {
                    ProcessLabeledListItem(new ParserContext(container, delimiterRegex), reader, ref buffer, ref attributes);
                    continue;
                }
                else if (PatternMatcher.Block.IsMatch(reader.Line))
                {
                    ...
                    switch (delimiter)
                    {
                        ...
                        case Patterns.Block.Literal:
                            Parse<Literal>(container, reader, ref buffer, ref attributes);
                            break;
                        ...
                        case Patterns.Block.Pass:
                            ...
                            {
                                Parse<Stem>(container, reader, ref buffer, ref attributes);
                            }
                            else
                            {
                                Parse<Passthrough>(container, reader, ref buffer, ref attributes);
                            }
                            break;
        ...
        private void Parse(Container parent, IDocumentReader reader, Regex delimiterRegex)
        {
            var buffer = new List<string>(8);
            AttributeList attributes = null;
            Parse(parent, reader, delimiterRegex, ref buffer, ref attributes);
        }

        private void Parse<TElement>(Container parent, IDocumentReader reader, ref List<string> buffer,
        ...
        private void ProcessBuffer(Container parent, ref List<string> buffer, ref AttributeList attributes)
        {
            if (buffer.Count > 0)
            {
                ...
                {
                    ProcessSimple<Passthrough>(parent, ref buffer, ref attributes);
                }
        ...
        private void ProcessCheckListItem(ParserContext context, IDocumentReader reader, ref List<string> buffer, ref AttributeList attributes)
        {
        ...
        private void ProcessLabeledListItem(ParserContext context, IDocumentReader reader, ref List<string> buffer, ref AttributeList attributes)
        {
            ProcessParagraph(context.Parent, ref buffer);
        ...
        private void ProcessOrderedListItem(ParserContext context, IDocumentReader reader, ref List<string> buffer, ref AttributeList attributes)
        {
            ProcessParagraph(context.Parent, ref buffer);
        ...
        private void ProcessUnorderedListItem(ParserContext context, IDocumentReader reader, ref List<string> buffer, ref AttributeList attributes)
        {
            ProcessParagraph(context.Parent, ref buffer);
