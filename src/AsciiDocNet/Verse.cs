namespace AsciiDocNet
{
    ...
    public class Verse : Container, IElement, IAttributable
    {
        ...
        /// </returns>
        public static bool operator ==(Verse left, Verse right) => Equals(left, right);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == this.GetType() && Equals((Verse)obj);
        }
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Verse" />, is equal to this instance.
        /// </summary>
        /// <param name="other">The other.</param>
        /// <returns>true if equal; otherwise, false</returns>
        protected bool Equals(Verse other) => base.Equals(other) && Attributes.Equals(other.Attributes);
    }
}